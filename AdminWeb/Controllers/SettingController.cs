...
public class SettingController : Controller
{
    ...
    {
        await UpdateSetting("GpsSensitivity", GpsSensitivity, "Độ nhạy GPS / Bán kính sai số bù trừ (mét)");
        await UpdateSetting("CooldownTimer", CooldownTimer, "Thời gian chờ (Cooldown) phát lại Audio (giây)");
